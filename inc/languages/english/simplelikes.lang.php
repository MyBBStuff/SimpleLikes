...
$l['simplelikes_like_others'] = '{1} and <a href="#pid{4}" onclick="MyBB.popupWindow(\'/misc.php?action=post_likes&amp;post_id={4}\', null, false); return false;">{2} others</a> {3} this post';
...
$l['simplelikes_error_perms_view'] = 'You do not have permission to view who liked this post.';
